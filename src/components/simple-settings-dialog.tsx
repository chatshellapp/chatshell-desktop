  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button variant="ghost" size="icon" onClick={handleOpen} className="size-8">
      ...
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          ...
          <DialogDescription>Configure your API keys and LLM provider settings.</DialogDescription>
        </DialogHeader>
        <div className="grid gap-4 py-4">
          ...
          <div className="grid gap-2">
            ...
            <p className="text-xs text-muted-foreground">
              Make sure Ollama is running locally and you have models installed (e.g., gemma3:12b,
          ...
          <div className="grid gap-2">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent className="w-[450px] max-h-[300px] overflow-y-auto">
                ...
                {models.map((model) => (
                  <DropdownMenuItem key={model.id} onClick={() => setSummaryModelId(model.id)}>
